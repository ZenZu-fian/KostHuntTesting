<%-- 
    Document   : index
    Created on : 14 Okt 2025, 16.30.35
    Author     : Ghaisani
--%>
    ...
    <body>
        ...
        <section class="area-kos-container">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="area-kos" onclick="window.location.href='<%= request.getContextPath() %>/kost?action=search&query=bandung'">
                            <img src="https://www.iroamly.com/images/bandung-indonesia-cover.webp" alt="Kost Bandung">
                            <div class="area-kos-text">Kost Bandung</div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="area-kos" onclick="window.location.href='<%= request.getContextPath() %>/kost?action=search&query=jogja'">
                            <img src="https://wallpapercave.com/wp/wp9451651.jpg" alt="Kost Jogja">
                            <div class="area-kos-text">Kost Jogja</div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="area-kos" onclick="window.location.href='<%= request.getContextPath() %>/kost?action=search&query=solo'">
                ...
                <div class="row">
                    <%
                        ...
                        try {
                            ...
                            String query = "SELECT idKost as id, nameKost as name, address, status, price, image_url, rating as avg_rating FROM kosts WHERE status != 0";
