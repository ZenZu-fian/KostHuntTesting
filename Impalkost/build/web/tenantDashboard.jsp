        ...
        <div class="main-container">
            ...
            <div class="rental-card">
                ...
                <div class="rental-actions">
                    ...
                    <a href="payment?action=showForm&roomId=<%= currentRental.get("room_id")%>&kostId=<%= currentRental.get("kost_id")%>" class="btn btn-primary">
                        <i class="fas fa-credit-card"></i>
                        Bayar Bulan Berikutnya
                    </a>
                    <a href="review?action=showForm&roomId=<%= currentRental.get("room_id")%>&kostId=<%= currentRental.get("kost_id")%>" class="btn btn-secondary">
