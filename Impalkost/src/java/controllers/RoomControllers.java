...
public class RoomControllers extends HttpServlet {
    ...
    private void addRoom(HttpServletRequest request, HttpServletResponse response) 
        ...
        try {
            ...
            stmt.executeUpdate();
            response.sendRedirect("RoomControllers?action=list&success=add");
            
        } catch (SQLException e) {
            e.printStackTrace();
            response.sendRedirect("RoomControllers?action=add&error=true");
        } finally {
            db.disconnect();
        }
    }
    ...
    private void editRoom(HttpServletRequest request, HttpServletResponse response) 
        ...
        try {
            ...
            stmt.executeUpdate();
            response.sendRedirect("RoomControllers?action=list&success=edit");
            
        } catch (SQLException e) {
            e.printStackTrace();
            response.sendRedirect("RoomControllers?action=edit&roomId=" + roomId + "&error=true");
        } finally {
            db.disconnect();
        }
    }
